...
__all__ = ["MyanimelistMangaDemographicsBuilder"]


class MyanimelistMangaDemographicsBuilder(MyAnimeListClientWithHelper):
    """The base class for manga demographics builder"""
