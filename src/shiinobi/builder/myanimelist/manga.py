...
__all__ = ["MangaBuilder"]


class MangaBuilder(MyAnimeListClientWithHelper):
    """The base class for manga builder"""
    ...
    def __build_urls_to_visit(self) -> Set[int]:
        ...
        pattern = re.compile(r"https://myanimelist\.net/sitemap/manga-\d+\.xml")
